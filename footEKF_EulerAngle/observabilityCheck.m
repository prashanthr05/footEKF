...
%% Observability test - Foot Without Compliance
% zeroth order lie derivative
dLf0h = dh_dx_withoutCompliance;
...
fprintf('\nObservability of foot states in case of compliance\n');
fprintf('# Observable States : %d \n', observable_states);
fprintf('# Unobservable States : %d \n', unobservable_states);
